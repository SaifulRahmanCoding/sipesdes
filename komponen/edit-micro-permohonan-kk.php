<?php
// query panggil data
$query = "SELECT * FROM tb_register_surat INNER JOIN permohonan_kk ON tb_register_surat.no_surat = permohonan_kk.no_surat WHERE tb_register_surat.no_surat='$no_surat'";
$result = mysqli_query($db, $query);

// definisikan data
foreach ($result as $penduduk) {
	$tgl_surat = $penduduk['tgl_surat'];
	$nama = $penduduk['nama'];
	...
	$nm_kp = $penduduk['nm_kp'];
	$id_pejabat = $penduduk['id_pejabat'];
}
?>
<div class="wrap shadow-sm p-3 mt-3">
	<form action="action/action-permohonan-kk.php?opsi=update" method="POST">
		<div class="row ps-3">
			<!-- kiri -->
			<div class="col-5 me-5">
				...
				<div class="form-group mb-1 d-flex align-items-center">
					...
					<input name="kp_kk" id="kp_kk"  class="form-control bg-light" type="text" value="<?php echo $nm_kp ?>" required>
				</div>
