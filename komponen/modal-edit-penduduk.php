...
<a class="text-decoration-none fs-6 bg-success bg-gradient text-white py-1 ps-2 pe-1 rounded-start" data-bs-toggle="modal" data-target="#EditPenduduk<?php echo $penduduk['id_penduduk']?>" href="#EditPenduduk<?php echo $penduduk['id_penduduk']?>"><i class="fas fa-edit"></i></a>
<!-- Modal -->
		...
		<div class="modal-content">
			...
			<div class="modal-body ps-4">
				...
				<div class="modal-footer justify-content-center">
					<input type="submit" name="submit" value="Edit Data" class="btn btn-dark text-white col-11 p-2">
				</div>
				<!-- end footer -->
			</form>
			<!-- end form -->
