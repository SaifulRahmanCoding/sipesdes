			...
			<div class="isi-konten m-4">
				<div class="container">
					...
					<div class="wrap shadow-sm p-3 mt-3">
						<form action="action/action-sku.php?opsi=input" method="POST">
							<div class="row ps-3">
								<!-- kiri -->
								...
								<div class="col-6">
									...
									<div class="form-group mb-1 d-flex align-items-center">
										<label for="nikah" class="col-3 pt-3 pb-3 me-4">Status Nikah</label>
									...
									<div class="form-group mb-1 d-flex align-items-center">
										...
										<textarea class="form-control bg-light" id="keterangan" name="keterangan"></textarea>
									</div>
									...
									<div>
										<label for="bantuan" class="mb-2 col-3 me-4">Bantuan &nbsp<?php $j_surat = "sku"; require('komponen/modal-bantuan.php'); ?></label>
									</div>
