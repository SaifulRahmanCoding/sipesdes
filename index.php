	...
	<div id="bungkus" class="d-flex">
		...
		<div id="konten">
			...
			<div class="isi-konten m-3">
				<h4 class="fw-bolder text-center mt-4 mb-4">Sistem Informasi Pelayanan Surat Desa Bantal</h4>
			...
			<!-- footer konten -->
			<div class="footer">
				<span>Copyright 2022 Saiful Rahman. Universitas Ibrahimy Situbondo.</span>
			</div>
		</div>
		<!-- end konten -->
	</div>
