			...
			<div class="isi-konten m-4">
				<div class="container">
					...
					<div class="wrap shadow-sm p-3">
						<h4 class="fw-bolder">Form Surat Keterangan Tidak Mampu</h4>
						<!-- form temukan NIK -->
					...
					<div class="wrap shadow-sm p-3 mt-3">
						<form action="action/action-sktm.php?opsi=input" method="POST">
							<div class="row ps-3">
								<!-- kiri -->
								...
								<div class="col-6">
									...
									<div class="form-group mb-1 d-flex align-items-center">
										...
										<textarea class="form-control bg-light" id="keperluan" name="keperluan" required></textarea>
									</div>

									<div>
										<label for="bantuan" class="mb-2 col-3 me-4">Bantuan &nbsp<?php $j_surat = "sktm"; require('komponen/modal-bantuan.php'); ?></label>
									</div>

								</div>
							</div>

							<input type="submit" name="submit" value="Buat Surat" class="btn btn-dark col-2 ms-3 mt-3">
						</form>
					</div>
