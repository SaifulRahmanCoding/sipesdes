...
<head>
	...
	<title>Buat Surat Permohonan KK</title>
	<?php 
			...
			<div class="isi-konten m-4">
				<div class="container">
					...
					<div class="wrap shadow-sm p-3 mt-3">
						<form action="action/action-permohonan-kk.php?opsi=input" method="POST">
							<div class="row ps-3">
								<!-- kiri -->
								<div class="col-5 me-5">
									...
									<div class="form-group mb-1 d-flex align-items-center">
										...
										<input name="no_surat" id="no_surat"  class="form-control bg-light" type="text" value="<?php echo $no_surat_auto?>" required>
									</div>
