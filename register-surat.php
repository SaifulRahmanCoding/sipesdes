			...
			<div class="isi-konten m-3">
				...
				<div class="wrap col table-responsive shadow-sm rounded p-3">
					...
					if ($sessionLevel == "admin") : ?>
						<form action="cetak/cetak-register-surat.php" method="POST" target="_blank">
							<div class="form-group mb-2 d-flex">

								<div class="col-2">
									<input type="date" name="date_awal" class="form-control" id="date_awal" required />
								</div>

								<span class="mx-2 mt-2">-</span>

								<div class="col-2">
									<input type="date" name="date_akhir" class="form-control" id="date_akhir" required />
								</div>

								<input class="btn btn-success mb-3 mx-3" type="submit" value="Cetak Register Surat" style="font-size: 13px!important;" />
							</div>
						</form>
