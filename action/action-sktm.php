...
if ($opsi == "input") {
	...
	$query = "INSERT INTO sktm(no_surat, pekerjaan, keperluan) VALUES ('$no_surat','$pekerjaan','$keperluan')";
	...
	$query = "UPDATE sktm SET pekerjaan = '$pekerjaan', keperluan = '$keperluan' WHERE no_surat = '$no_surat'";
	$update_sktm = mysqli_query($db,$query);
